...
/**
 * コレクションに対する親子関係のアクセス制御のテスト.<br />
 * MOVEメソッドはMoveCollectionAccessControlTestクラスでテストしているため、本クラスではテストを省略している。
 */
@RunWith(DcRunner.class)
@Category({Unit.class, Integration.class, Regression.class })
public class WebDAVCollectionAccessControlTest extends JerseyTest {
     ...
     * コンストラクタ.
     */
    public WebDAVCollectionAccessControlTest() {
    ...
    /**
     * 存在しないリソースにACLを設定すると404エラーとなること.
     * @throws JAXBException ACLのパース失敗
     */
    @Test
    public void 存在しないリソースにACLを設定すると404エラーとなること() throws JAXBException {
        TResponse res = DavResourceUtils.setACLwithBox(CELL_NAME, AbstractCase.MASTER_TOKEN_NAME,
