...
public final class OAuth2Helper {
    ...
    public static class Key {
         ...
         */
        public static final QName PROP_KEY_OWNER_REPRESENTIVE_ACCOUNTS = new QName(DcCoreUtils.XmlConst.NS_DC1,
                "ownerRepresentativeAccounts");
        /**
         * ownerRepresentativeAccount.
         */
        public static final QName PROP_KEY_OWNER_REPRESENTIVE_ACCOUNT = new QName(DcCoreUtils.XmlConst.NS_DC1,
                "account");
    }
