...
//     * Edm EntityType名.
//     */
//    public static final String EDM_TYPE_NAME = "Domain";
//    /**
//     * Nameプロパティの定義体.
//     */
...
//            .setNamespace(Common.EDM_NS_UNIT_CTL).setName(EDM_TYPE_NAME)
//            .addProperties(Enumerable.create(P_NAME, Common.P_PUBLISHED, Common.P_UPDATED).toList())
