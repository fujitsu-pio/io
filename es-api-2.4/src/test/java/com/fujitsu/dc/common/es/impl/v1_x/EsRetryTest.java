...
public class EsRetryTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        Settings settings = Settings.settingsBuilder()
                ...
                .put("plugin.mandatory", "delete-by-query")
                //.put("plugin.types", DeleteByQueryPlugin.class.getName())
                // https://github.com/elastic/elasticsearch/issues/13212
                // https://github.com/elastic/elasticsearch/pull/15107
                .put("path.plugins", "C:/soft/elasticsearch-2.3.3/plugins")
